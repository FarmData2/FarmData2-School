<template>
  ...
  >
    ...
    <input
      ...
      v-bind:disabled="!validHarvestLog"
    />
    <input
      type="button"
      id="harvest-reset"
  ...
  data() {
    return {
      ...
      plantList: [
        ...
        { id: 2, date: '04/02/2023', location: 'GHANA', bed: 'GHANA-2' },
        { id: 3, date: '04/02/2009', location: 'GHANA', bed: 'GHANA-4' },
        { id: 4, date: '06/05/2015', location: 'GHANA', bed: 'GHANA-4' },
      ],
