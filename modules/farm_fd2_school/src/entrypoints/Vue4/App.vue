...
export default {
  data() {
    return {
      ...
      plantList: [
        { id: 1, date: '08/20/2023', location: 'D', bed: '' },
        { id: 2, date: '09/11/1973', location: 'GHANA', bed: 'GHANA-2' },
        { id: 3, date: '06/02/2020', location: 'GHANA', bed: 'GHANA-4' },
        { id: 4, date: '12/26/1991', location: 'GHANA', bed: 'GHANA-4' },
      ],
