describe('HTML and CSS: Submission tests', () => {
  beforeEach(() => {
  ...
  it('Test successful submission', () => {
    ...
    cy.get('.toast')
      .should('be.visible')
      .should('contain.text', 'Submitting HTML and CSS...');
    ...
    cy.get('.toast', { timeout: 10000 })
      .should('be.visible')
      .should('contain.text', 'HTML and CSS created.');
  ...
  it('Test submission with network error', () => {
    ...
    cy.get('.toast')
      .should('be.visible')
      .should('contain.text', 'Error creating HTML and CSS records.');
