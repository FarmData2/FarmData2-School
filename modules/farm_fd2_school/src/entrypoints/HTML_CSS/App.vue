  ...
  >
    ...
    >
      ...
      >
        ...
        <SubmitResetButtons
          id="HTML-CSS-submit-reset"
          data-cy="HTML-CSS-submit-reset"
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.validToSubmit) {
         ...
         * that the tests in HTML_CSS.submission.e2e.cy.js and
         * HTML_CSS.submitError.e2e.cy.js have their own copy that
        ...
        lib
          ...
          .catch(() => {
            ...
            if (!this.errorShown) {
              ...
              uiUtil
                .showToast(
                  'Error creating HTML and CSS records.',
